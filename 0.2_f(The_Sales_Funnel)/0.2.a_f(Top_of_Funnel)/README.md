# 0.2.a f(Top_of_Funnel)

**f(TOF) = Awareness + Lead Generation**
...
Input decomposed into 9 spatial scales via Gaussian pyramids
Feature channels extracted: Intensity, Color (RG, BY opponency), Orientation (4 angles)
Center-surround operations create feature maps (42 total)
Normalization operator N(·) promotes maps with few strong peaks
Conspicuity maps combined:
f(Saliency) = (1/3)[N(Ī) + N(C̄) + N(Ō)]
Winner-take-all network selects most salient location
...
| Section | Status |
|---------|--------|
| [0.2.a.i f(Awareness)](./0.2.a.i_f(Awareness)/) | 🔴 Planned |
| [0.2.a.ii f(Lead_Generation)](./0.2.a.ii_f(Lead_Generation)/) | 🔴 Planned |
